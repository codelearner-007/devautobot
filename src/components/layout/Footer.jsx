        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-2.5 mb-5">
              <Image src="/logo.png" alt={site.name} width={200} height={40} className="h-14 w-auto object-contain" />
              <span className="font-heading font-800 text-lg tracking-tight bg-gradient-to-r from-[#4a5262] via-[#9ca3af] to-[#22d3ee] bg-clip-text text-transparent translate-y-1">
                {site.name}
              </span>
            </Link>
