...
import { ArrowRight, Globe, Code2, TrendingUp, Zap, ShoppingCart } from 'lucide-react';
        ...
        <div className="grid lg:grid-cols-[1fr_1.1fr] gap-12 xl:gap-20 items-center">
          ...
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
            ...
            >
              ...
              <div className="h-px w-8 bg-primary lg:hidden" />
            </motion.div>
          ...
          >
            ...
            >
              ...
              <div className="relative w-full glass-card rounded-3xl overflow-hidden border border-primary/10 shadow-2xl z-10">
                {/* Chrome bar */}
                <div className="flex items-center gap-2 px-5 py-3.5 border-b border-border bg-foreground/[0.03]">
                ...
                {/* Fake site content */}
                <div className="relative p-5 bg-[linear-gradient(135deg,rgba(6,182,212,0.04),transparent)]">
                  ...
                  <div className="rounded-2xl p-6 mb-4 border border-primary/10 bg-[rgba(6,182,212,0.06)]">
                  ...
                  <div className="grid grid-cols-3 gap-2.5">
                    {[Code2, ShoppingCart, Globe].map((Icon, i) => (
                      <div key={i} className="rounded-xl p-3 bg-foreground/[0.04] border border-border">
                        <Icon size={14} className="text-primary/40 mb-2" />
                ...
                <div className="flex items-center gap-3 px-5 py-2.5 border-t border-border bg-foreground/[0.02]">
                  ...
                  <div className="flex items-center gap-1.5 flex-1">
                    <div className="h-1.5 flex-1 rounded-full bg-foreground/8 overflow-hidden">
                      <div className="h-full w-[94%] rounded-full bg-primary/50" />
                    </div>
                  </div>
              ...
              <motion.div
                ...
                className="absolute -bottom-5 -left-10 glass-card px-4 py-3 rounded-2xl border border-primary/20 shadow-2xl z-20"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs font-bold leading-tight">Delivered in 2 wks</p>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs font-bold leading-tight">SEO Score: 98/100</p>
                    <p className="text-[10px] text-primary mt-0.5">Fully optimised ✓</p>
                  </div>
                </div>
              </motion.div>
