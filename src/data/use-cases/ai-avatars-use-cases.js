...
export const useCases = [
  ...
  { emoji: '👥', industry: 'HR & Internal', title: 'Corporate Training & Compliance', description: 'Deliver consistent policy training, onboarding programmes, and compliance updates in any language across global teams.' },
  { emoji: '🎯', industry: 'Sales', title: 'Personalised Outbound Video Emails', description: 'Stand out in a crowded inbox with a personalised AI video that addresses the prospect by name and speaks to their specific pain.' },
  { emoji: '🌍', industry: 'Global', title: 'Global Content Localisation', description: 'Localise existing video content into 50+ languages without re-filming — maintaining brand consistency across every market.' },
];
